...
export class UIUXProMaxAgent {
  ...
  static readonly SYSTEM_PROMPT = AGENT_SYSTEM_PROMPT;
  ...
  private parseReviewResponse(
    ...
    try {
      ...
      const parsed = JSON.parse(jsonMatch[0]) as Partial<UIUXAgentOutput>;
  ...
  // 默认维度评分
  private getDefaultDimensions(): UIUXAgentOutput["dimensions"] {
    return {
