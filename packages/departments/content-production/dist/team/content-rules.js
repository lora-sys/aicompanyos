 ...
 */
export const RULE_PREMIUM_FULL_TEAM = {
    id: "cp-premium-full-team",
    match: (f) => f.complexity === "high" &&
 ...
 */
export const RULE_RESEARCH_HEAVY = {
 ...
 */
export const RULE_VISUAL_CREATIVE = {
    id: "cp-visual-creative",
    match: (f) => f.hasVisualContent === true &&
        f.complexity !== "high",
    team: [
        { role: "writer", priority: "essential" },
        { role: "critic", priority: "essential" },
 ...
 */
export const RULE_LIGHT_RESEARCH = {
    id: "cp-light-research",
    match: (f) => f.needsResearch === true &&
        f.complexity !== "high",
    team: [
        { role: "writer", priority: "essential" },
        { role: "critic", priority: "essential" },
 ...
 */
export const RULE_PREMIUM_CORE = {
    id: "cp-premium-core",
    match: (f) => f.qualityTier === "premium" &&
        f.complexity !== "high" &&
 ...
 * 团队：Writer + Critic
 */
export const RULE_STANDARD = {
    id: "cp-standard",
    match: (f) => f.qualityTier === "standard" &&
...
// ============================================================
/** 内容产出部全部团队组合规则（有序） */
export const CONTENT_TEAM_RULES = [
