...
// ============================================================
/** 图文文章的 Critic 评估维度 */
export const ARTICLE_CRITIC_DIMENSIONS = [
    {
        id: "article_depth",
        name: "内容深度与洞察力",
        ...
        scoringGuide: "20分: 有原创性洞察或框架，读者读后获得'原来如此'的认知升级\n" +
    ...
    },
    {
        ...
        maxScore: 20,
        excellenceThreshold: 17,
        scoringGuide: "20分: 结构精妙，起承转合自然，读者能顺畅跟随作者思路\n" +
    ...
    },
    {
        ...
        scoringGuide: "15分: 关键词自然融入标题/首段/小标题/正文，密度1.5%-3%\n" +
    ...
    },
    {
        ...
        maxScore: 20,
        excellenceThreshold: 17,
        scoringGuide: "20分: 语言精准有力，金句频出，几乎无可删减的冗余\n" +
    ...
    },
    {
        ...
        scoringGuide: "10分: CTA 自然有力，与文章主题高度相关，有明确行动指引\n" +
            "7-9分: 有CTA但略显生硬或不够具体\n" +
            "4-6分: CTA模糊或缺失\n" +
            "0-3分: 无任何互动引导",
    },
    {
        ...
        maxScore: 15,
        excellenceThreshold: 12,
        scoringGuide: "15分: 完全围绕核心主题展开，每个段落都服务于主旨\n" +
...
// ============================================================
/** 种草笔记的 Critic 评估维度 */
export const SEED_CRITIC_DIMENSIONS = [
    {
        ...
        scoringGuide: "25分: 标题有强烈好奇心缺口或情绪共鸣，首图描述让人想立刻看全文\n" +
    ...
    },
    {
        ...
        maxScore: 25,
        excellenceThreshold: 21,
        scoringGuide: "25分: 读起来像朋友真心推荐，有细节/感受/小缺点增加可信度\n" +
    ...
    },
    {
        ...
        maxScore: 15,
        excellenceThreshold: 12,
        scoringGuide: "15分: Emoji ≥5个，每个位置恰到好处，增强情感表达不显多余\n" +
    ...
    },
    {
        ...
        scoringGuide: "20分: 种草逻辑完整（痛点→产品→效果→行动），转化路径清晰\n" +
            "15-19分: 种草要素齐全但某环节稍弱\n" +
    ...
    },
    {
        ...
        maxScore: 15,
        excellenceThreshold: 12,
        scoringGuide: "15分: #话题标签# 格式正确(5-10个)，每段≤4行，CTA位置恰当\n" +
            "11-14分: 格式基本合规，有小瑕疵\n" +
...
// ============================================================
/** 短视频脚本的 Critic 评估维度 */
export const SHORT_VIDEO_CRITIC_DIMENSIONS = [
    {
        id: "sv_hook",
        name: "黄金3秒钩子强度",
        ...
        maxScore: 25,
        excellenceThreshold: 21,
        scoringGuide: "25分: 钩子极具冲击力（悬念/冲突/反常识），观众必看下去\n" +
    ...
    },
    {
        ...
        maxScore: 25,
        excellenceThreshold: 21,
        scoringGuide: "25分: 节奏紧凑，每5秒一个信息点，纯口语化，朗朗上口\n" +
    ...
    },
    {
        ...
        maxScore: 20,
        excellenceThreshold: 16,
        scoringGuide: "20分: 所有场景标记完整且具象，导演可直接按脚本拍摄\n" +
    ...
    },
    {
        ...
        maxScore: 20,
        excellenceThreshold: 16,
        scoringGuide: "20分: 悬念层层递进，反转出人意料，情绪曲线精心设计\n" +
    ...
    },
    {
        ...
        maxScore: 10,
        excellenceThreshold: 8,
        scoringGuide: "10分: CTA 与内容自然衔接，有明确的行动指引和理由\n" +
            "7-9分: 有CTA但略显突兀\n" +
            "4-6分: CTA模糊或缺失\n" +
            "0-3分: 无任何结尾互动引导",
    },
...
export const NEWSLETTER_CRITIC_DIMENSIONS = [
    {
        id: "nl_open_rate",
        name: "打开率要素（标题+预览文本）",
        ...
        maxScore: 20,
        excellenceThreshold: 16,
        scoringGuide: "20分: 标题有强烈的好奇心/价值/个性化元素，预览文本完美互补\n" +
            "15-19分: 标题吸引人，预览文本尚可\n" +
    ...
    },
    {
        ...
        maxScore: 20,
        excellenceThreshold: 16,
        scoringGuide: "20分: 每句话都有价值，无一句废话，排版舒适易扫读\n" +
    ...
    },
    {
        ...
        maxScore: 25,
        excellenceThreshold: 21,
        scoringGuide: "25分: 读完获得多个可立即使用的洞察/工具/方法论\n" +
    ...
    },
    {
        ...
        maxScore: 20,
        excellenceThreshold: 16,
        scoringGuide: "20分: 强烈的个人风格，读者感觉在和真人对话\n" +
            "15-19分: 有个人色彩但偶尔显得正式\n" +
            "9-14分: 个人感较弱，接近通用模板\n" +
            "0-8分: 完全的企业公关腔或AI生成感",
    },
    {
        ...
        maxScore: 15,
        excellenceThreshold: 12,
        scoringGuide: "15分: 完全安全，零触发词，格式规范\n" +
...
export function getCriticDimensions(contentType) {
    switch (contentType) {
        case "article":
