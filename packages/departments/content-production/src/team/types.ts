...
// ============================================================
// 1. ContentWorkerConfig — 内容部门 Worker 配置扩展
// ============================================================
...
/** 默认团队配置 */
export const DEFAULT_CONTENT_TEAM_CONFIG: ContentTeamConfig = {
