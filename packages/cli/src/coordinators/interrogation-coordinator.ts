import type { InterrogateEngine, InterrogationSession } from "@aicos/loop-engine";
...
export class InterrogationCoordinator {
  ...
  private activeModal: InterrogateModal | null = null;
  private resolvePromise: (() => void) | null = null;
  private cachedResults: Record<string, string> = {};
  private userModificationCount = 0;
   ...
   */
  async start(taskInput: string): Promise<void> {
