...
import { PiAILLMProvider, type LLMProvider } from "@aicos/loop-engine";
 ...
 */
function createPiAiModel(): import("@earendil-works/pi-ai").Model<"openai-completions"> | undefined {
  ...
  const fallbackModel = (): import("@earendil-works/pi-ai").Model<"openai-completions"> => ({
    id: modelId,
    name: modelId,
