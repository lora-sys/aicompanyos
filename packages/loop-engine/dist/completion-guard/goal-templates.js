...
export class GoalTemplateRegistry {
     ...
     */
    generateGoals(stepId, agentType, description) {
    ...
    /** 检查模板是否匹配 */
    matchesTemplate(template, agentType, lowerDesc) {
    ...
    // ============================================================
    /** 代码实现类目标的默认集合 */
    generateCodeGoals(stepId, _desc) {
        return [
            {
    ...
    /** 文章/内容写作类目标的默认集合 */
    generateArticleGoals(stepId, _desc) {
        return [
            {
                id: `${stepId}_file_exists`,
                stepId,
    ...
    /** 通用 Writer 兜底目标 */
    generateGenericWriterGoals(stepId, _desc) {
        return [
            {
...
//# sourceMappingURL=goal-templates.js.map