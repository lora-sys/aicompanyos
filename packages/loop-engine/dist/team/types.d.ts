 ...
 */
export type WorkerRole = "writer" | "critic" | "researcher" | "uiux-designer" | "reviewer";
/** 所有支持的 Worker 角色 */
 ...
 * 内容领域分类
 */
export type ContentDomain = "tech" | "lifestyle" | "finance" | "education" | "general";
/**
...
/** 篇幅阈值常量 */
export declare const LENGTH_THRESHOLDS: {
    readonly shortChars: 500;
    readonly mediumChars: 2000;
};
/**
 * 团队 — 一次任务执行的 Agent 集合
 *
 ...
 */
export type AgentFactory = (ctx: import("../orchestrator/types.js").OrchestratorAgentContext) => import("../loop-module/index.js").IGeneratorAgent<any, any> | import("../loop-module/index.js").IEvaluatorAgent | import("../orchestrator/types.js").AgentExecutor;
/**
