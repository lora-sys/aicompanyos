...
export type ContentType =
  | "article"        // 图文/长文（公众号/知乎）: 2000-3500字, 专业深度
  | "seed"           // 种草/短图文（小红书/Instagram）: 300-800字, 轻松亲切
  | "short-video"    // 短视频脚本（抖音/TikTok）: 500-1000字口播, 节奏快
  | "newsletter";    // Newsletter/周报（Substack）: 800-2000字, 个人化
...
// ============================================================
// 2. AgentProfile — 部门专属的 Agent 人格配置
// ============================================================
...
export interface WriterConstraints {
  ...
  structureRequirement?: {
    mustHaveSections?: string[];      // 必须包含的章节名称
    maxSectionLength?: number;         // 单节最大长度（字数）
  };
   ...
   */
  tone?:
    | "professional"   // 专业、客观、有权威感
    | "casual"          // 轻松、随意、像朋友聊天
    | "humorous"        // 幽默、风趣、有梗
    | "emotional"       // 感性、有感染力、讲故事
    | "storytelling";   // 叙事性强、有起承转合
...
// ============================================================
// 4. OutputPipelineConfig — 多格式输出管线
// ============================================================
...
export type PlatformType =
  ...
  | "xiaohongshu"   // 小红书
  | "douyin"        // 抖音/TikTok
  | "substack"      // Substack / 邮件列表
  | "generic";      // 通用（纯 Markdown / 无平台适配）
...
export interface QualityCheckerProcessor {
  ...
  checks: Array<{
    ...
    name: string;
    /** 检查类型 */
    type: "word_count_min" | "word_count_max" | "has_title"
      | "no_broken_links" | "spam_score" | "custom_regex";
    /** 检查参数 */
...
// ============================================================
// 7. OutputResult — 经过 Pipeline 处理后的最终产物
// ============================================================
