...
// ============================================================
// 3. 验收目标（AcceptanceGoal + GoalStatus）
// ============================================================
...
export const DEFAULT_COMPLETION_GUARD_CONFIG: CompletionGuardConfig = {
  maxEffort: 20,
  maxRetriesPerGoal: 3,
